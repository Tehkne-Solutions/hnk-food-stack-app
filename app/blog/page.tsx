...
import {
    BookOpen, PenTool, Share2, MessageSquare, Zap, Users
} from 'lucide-react'
...
export default function BlogPage() {
    const features = [
        {
            icon: PenTool,
            title: "Criar Artigos Facilmente",
            description: "Editor visual intuitivo para seus conteúdos"
        },
        {
            icon: Share2,
            title: "Compartilhamento Social",
            description: "Distribua automaticamente em redes sociais"
        },
        {
            icon: MessageSquare,
            title: "Comentários e Interação",
            description: "Crie comunidade ao redor de seu conteúdo"
        },
        {
            icon: Users,
            title: "SEO Otimizado",
            description: "Atraia mais clientes através de busca orgânica"
        }
    ]
        ...
        <main className="w-full bg-[#050505] min-h-screen">
            ...
            <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10 text-center">
                    ...
                    >
                        Compartilhe experiências, receitas e histórias com sua comunidade de clientes.
                    </motion.p>
                </div>
            </section>
