...
/**
 * 🏠 Home Page - HNK Food Stack
 */

import { useTheme } from '@/providers/theme-provider'
import Link from 'next/link'
import { Utensils, Menu, Calendar, BarChart3 } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{
          background: `linear-gradient(135deg, ${theme?.primary_color || '#d97706'}, ${theme?.secondary_color || '#1a1a1a'})`,
        }}
      >
