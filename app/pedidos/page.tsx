...
import {
    ClipboardList, Zap, BarChart3, Bell, Clock, Truck
} from 'lucide-react'
...
export default function PedidosPage() {
    const features = [
        ...
        },
        {
            ...
            description: "Analise tendências e padrões de vendas"
        },
        {
            icon: Bell,
            title: "Notificações Inteligentes",
            description: "Alertas automáticos para novos pedidos"
        },
        {
            icon: Truck,
            title: "Integração de Entrega",
            description: "Conecte com suas plataformas de delivery"
        }
    ]
        ...
        <main className="w-full bg-[#050505] min-h-screen">
            ...
            <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10 text-center">
                    ...
                    >
                        Gerencie todos os seus pedidos em um único painel intuitivo com total controle e visibilidade.
                    </motion.p>
                </div>
            </section>
