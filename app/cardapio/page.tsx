...
import {
    Utensils, Zap, ShieldCheck, Target, Globe, Rocket
} from 'lucide-react'
    ...
    const features = [
        {
            ...
            description: "Modifique preços e disponibilidade instantaneamente"
        },
        {
            icon: ShieldCheck,
            title: "Segurança de Dados",
            description: "Informações do cliente protegidas com criptografia"
        },
        {
            icon: Globe,
            title: "Acesso Global",
            description: "Disponível 24/7 em qualquer dispositivo"
        },
        {
            icon: Rocket,
            title: "Performance Ultra",
            description: "Carregamento em menos de 1 segundo"
        }
    ]
        ...
        <main className="w-full bg-[#050505] min-h-screen">
            ...
            <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10 text-center">
                    ...
                    >
                        Experiência Premium no Seu Cardápio
                    </motion.h2>
                    ...
                    >
                        Transforme seu menu em uma experiência imersiva com nossa plataforma de cardápio digital Glass-Noir.
                    </motion.p>
                </div>
            </section>
