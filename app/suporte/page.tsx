...
import {
    Headphones, BookMarked, MessageCircle, Shield, Clock, Users
} from 'lucide-react'
...
export default function SuportePage() {
    const features = [
        ...
        },
        {
            ...
            description: "Centenas de artigos e tutoriais"
        },
        {
            icon: MessageCircle,
            title: "Chat em Tempo Real",
            description: "Resolva problemas instantaneamente"
        },
        {
            icon: Shield,
                ...
                <div className="max-w-4xl mx-auto relative z-10 text-center">
                    ...
                    >
                        <div className="p-4 bg-gradient-to-br from-amber-500/10 to-orange-700/10 border border-amber-500/30 rounded-full">
                            <Headphones size={40} className="text-amber-500" />
                        </div>
                    </motion.div>
                    ...
                    >
                        Contamos com uma equipe especializada pronta para resolver suas dúvidas e otimizar sua experiência.
                    </motion.p>
                </div>
            </section>
