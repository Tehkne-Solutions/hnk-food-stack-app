...
import {
    Brain, Zap, Cpu, Lightbulb, Target, Sparkles
} from 'lucide-react'
    ...
    const features = [
        {
            ...
            description: "Algoritmos que aprendem com seus dados"
        },
        {
            icon: Sparkles,
            title: "Recomendações Inteligentes",
            description: "Sugira pratos baseado no histórico do cliente"
        },
        {
            icon: Target,
            title: "Previsão de Demanda",
            description: "Antecipe quais pratos serão mais vendidos"
        },
        {
            icon: Lightbulb,
            title: "Otimização Automática",
            description: "IA ajusta preços e promoções dinamicamente"
        }
    ]
        ...
        <main className="w-full bg-[#050505] min-h-screen">
            ...
            <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10 text-center">
                    ...
                    >
                        Potencialize suas vendas com inteligência artificial de ponta, aprendizado de máquina e análise preditiva.
                    </motion.p>
                </div>
            </section>
